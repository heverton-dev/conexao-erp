-- ============================================================
-- FIX: Corrigir funções helper RLS e policies do catálogo
-- Problema: get_current_empresa_id() e is_super_admin_session()
-- foram sobrescritas SEM set search_path = '' pela migration
-- 20260718, causando retornos NULL ou erros silenciosos.
-- ============================================================
...
-- e mantém consistência com as funções corrigidas
...
-- 3. Garantir que a tabela profiles NÃO tem RLS bloqueando a própria leitura
-- (Essencial para que get_current_empresa_id() funcione)
ALTER TABLE public.profiles ENABLE ROW LEVEL SECURITY;

-- Policy de SELECT em profiles: o próprio usuário pode ver seu profile
-- E super admin pode ver todos
DO $$
BEGIN
...
-- 4. Verificação final: garantir que as funções existem e funcionam
DO $$
BEGIN
  ...
  END IF;
  RAISE NOTICE '✅ Funções helper verificadas com sucesso';
END $$;
