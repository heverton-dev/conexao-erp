...
async function run() {
  ...
  await step("Pagina do consultor carregada", async () => {
    await page.waitForTimeout(2000);
  });

  await step("Navegar para meus clientes", async () => {
    await page
      .goto(APP_URL + "/consultor/clientes", { waitUntil: "networkidle" })
      .catch(() => {});
    await page.waitForTimeout(2000);
  });
